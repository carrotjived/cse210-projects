    ...
    public void LoadFile()
    {
        ...
        if (File.Exists(fileName))
        {
            ...
            for (int index = 1; index < lines.Length; index++)
            {
                ...
                {
                    SimpleGoals newSimple = new(parts[1], parts[2], Convert.ToInt32(parts[3]), Convert.ToBoolean(parts[4]));
                ...
                {
                    CheckListGoals newChecklist = new(parts[1], parts[2], Convert.ToInt32(parts[3]), Convert.ToInt32(parts[4]), Convert.ToInt32(parts[5]), Convert.ToInt32(parts[6]), Convert.ToBoolean(parts[7]));
